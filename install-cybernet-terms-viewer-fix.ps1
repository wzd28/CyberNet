...
$CacheVersion = "20260804-2"

Write-Host ""
Write-Host "CyberNet AI - Terms Viewer Fix" -ForegroundColor Cyan
...
Write-Host "The Legal Center now renders Terms, Privacy, Refunds, and Acceptable Use directly inside the scrollable window." -ForegroundColor White
Write-Host "It no longer uses an iframe, so the site's anti-framing security headers can remain enabled." -ForegroundColor White
Write-Host "The signup and payment acceptance checkboxes remain required." -ForegroundColor White
Write-Host ""
